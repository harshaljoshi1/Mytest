    ...
    function runBlock($log, $rootScope, $state, $http, localStorageService) {
        ...
        $rootScope.$on('$stateChangeSuccess', function (event, toState) {
            ...
            if (userobj) {
                ...
                else if (toState.name == 'app.stats' || toState.name == 'app.anchor-agreement' || toState.name == 'app.modify-anchor-agreement' || toState.name == 'app.vendor-agreement' || toState.name == 'app.modify-vendor-agreement' || toState.name == 'app.anchor-program-initiation' || toState.name == 'app.anchor-program-pending'|| toState.name == 'app.anchor-registration' ) {
